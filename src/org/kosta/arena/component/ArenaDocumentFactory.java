 ...
 *
 */
public class ArenaDocumentFactory implements IDocFactory {

	private final static CLogger s_log = CLogger.getCLogger(ArenaDocumentFactory.class);
	...
	public Doc getDocument(MAcctSchema as, int AD_Table_ID, ResultSet rs,
		...
		String packageName = "org.kosta.acct";
