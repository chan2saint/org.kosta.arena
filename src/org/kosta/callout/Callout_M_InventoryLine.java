...
public class Callout_M_InventoryLine implements IColumnCallout {

	@Override
	public String start(Properties ctx, int WindowNo, GridTab mTab,
			GridField mField, Object value, Object oldValue) {
		if (mField.getColumnName().equals("M_Product_ID"))  
			return productUOM(ctx, WindowNo, mTab, mField,value);
	...
	public String productUOM (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		try
		{
			...
			rs = pstmt.executeQuery (); // checking product uom
			if (rs.next ()) {
