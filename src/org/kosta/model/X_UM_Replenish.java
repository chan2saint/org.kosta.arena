...
/** Generated Model for UM_Replenish
 *  @author iDempiere (generated) 
 *  @version Release 1.0c - $Id$ */
public class X_UM_Replenish extends PO implements I_UM_Replenish, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20140412L;

    /** Standard Constructor */
    public X_UM_Replenish (Properties ctx, int UM_Replenish_ID, String trxName)
    {
      super (ctx, UM_Replenish_ID, trxName);
      /** if (UM_Replenish_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_UM_Replenish (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UM_Replenish[")
	...
	/** Set DateReplenish.
		@param DateReplenish DateReplenish	  */
	public void setDateReplenish (Timestamp DateReplenish)
	{
		set_Value (COLUMNNAME_DateReplenish, DateReplenish);
	}

	/** Get DateReplenish.
		@return DateReplenish	  */
	public Timestamp getDateReplenish () 
	{
		return (Timestamp)get_Value(COLUMNNAME_DateReplenish);
	}
	...
	/** Set UM_Replenish_UU.
		@param UM_Replenish_UU UM_Replenish_UU	  */
	public void setUM_Replenish_UU (String UM_Replenish_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UM_Replenish_UU, UM_Replenish_UU);
	}

	/** Get UM_Replenish_UU.
		@return UM_Replenish_UU	  */
	public String getUM_Replenish_UU () 
	{
		return (String)get_Value(COLUMNNAME_UM_Replenish_UU);
	}
	
	public boolean isCreateFrom()
	{
		String isCreate = (String)get_Value(COLUMNNAME_CreateFrom);

		if ( isCreate != null){
			if ( isCreate.trim().equals("Y")) return true;
		else return false;
		}
		return false;
	}
